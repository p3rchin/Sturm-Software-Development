 ...
 *
 */
public class PanelJuegoSuperAstro extends JPanel {
	/*
	...
	/*
	 * valorApuesta, numero1, numero2, numero3, numero4 son de tipo JTextField.
	 */
	private JTextField valorApuesta, numero1, numero2, numero3, numero4;
	/*
	 * signo es de tipo JComboBox con parámetro String.
	 */
	private JComboBox<String> signo;
	/*
	 * informacion, apostar, aleatorio es de tipo Boton.
	 */
	private Boton informacion, apostar, aleatorio;
	 ...
	 * realizar el juego del super astro junto con los campos de texto y se utilizan
	...
	public void inicializarComponentes() {
		...
		volver.setActionCommand("VOLVERJUEGOSUPERASTRO");
		add(volver);
		...
		minimizar.setActionCommand("MINIZARJUEGOSUPERASTRO");
		add(minimizar);
		...
		cerrar.setActionCommand("CERRARJUEGOSUPERASTRO");
		add(cerrar);
		...
		informacion.setActionCommand("FAQSUPERASTRO");
		add(informacion);
		...
		aleatorio = new Boton();
		aleatorio.setBounds(480, 288, 38, 27);
		...
		aleatorio.setActionCommand("ALEATORIOSUPERASTRO");
		add(aleatorio);

		imagenBoton5 = new ImageIcon("recursos/apostarJuegoSuperAstro.png");
		recursoImagenBoton5 = new ImageIcon(imagenBoton5.getImage().getScaledInstance(218, 50, Image.SCALE_DEFAULT));
		apostar = new Boton();
		apostar.setBounds(248, 388, 218, 50);
		...
		apostar.setActionCommand("APOSTARSUPERASTRO");
		add(apostar);

		fondo = new ImageIcon(getClass().getResource("/imagenes/juegoSuperAstro.jpg"));

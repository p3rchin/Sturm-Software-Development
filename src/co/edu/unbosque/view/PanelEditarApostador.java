...
/**
 * Clase PanelEditarApostador.
 * 
 * Clase donde tiene los componentes para hacer el panel de editar del
 * apostador.
 * 
 ...
 *
 */
public class PanelEditarApostador extends JPanel {
	/*
	 ...
	 */
	private JTextField nombre, apellido, direccion, telefono;
	/*
	 * sede es de tipo JComboBox con parámetro String.
	 */
	private JComboBox<String> sede;
	/*
	 * editar es de tipo Boton.
	 */
	private Boton editar;
	...
	/*
	 * Método donde se inicializan los atributos que contiene el botón para editar
	 * junto con los campos de texto y se utilizan los diferentes componentes que
	 * son provenientes de la clase JPanel.
	 */
	public void inicializarComponentes() {
		...
		volver.setActionCommand("VOLVERDEEDITAR");
		add(volver);
		...
		minimizar.setActionCommand("MINIMIZAREDITAR");
		add(minimizar);
		...
		cerrar.setActionCommand("CERRAREDITAR");
		add(cerrar);
		...
		sede.setBounds(330, 204, 300, 25);
		sede.setFont(fuente1);
		sede.setVisible(true);
		add(sede);

		direccion = new JTextField();
		direccion.setBounds(330, 258, 300, 25);
		direccion.setFont(fuente1);
		direccion.setVisible(true);
		add(direccion);

		telefono = new JTextField();
		telefono.setBounds(330, 312, 300, 25);
		telefono.setFont(fuente1);
		telefono.setVisible(true);
		add(telefono);

		imagenBoton4 = new ImageIcon("recursos/botonEditar.png");
		recursoImagenBoton4 = new ImageIcon(imagenBoton4.getImage().getScaledInstance(130, 50, Image.SCALE_DEFAULT));
		editar = new Boton();
		editar.setBounds(340, 375, 130, 50);
		editar.setBorderPainted(false);
		editar.setContentAreaFilled(false);
		editar.setFocusPainted(false);
		editar.setIcon(recursoImagenBoton4);
		editar.setCursor(new Cursor(Cursor.HAND_CURSOR));
		editar.setActionCommand("EDITARAPOSTADOR");
		add(editar);

		fondo = new ImageIcon(getClass().getResource("/imagenes/editarApostador.jpg"));

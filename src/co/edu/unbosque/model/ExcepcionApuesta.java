...
/**
 * Clase ExcepcionApuesta.
 * 
 * Clase donde se crea una excepción personalizada de la apuesta.
 * 
...
public class ExcepcionApuesta extends Exception {
	...
	/**
	 * Constructor específico que crea la ExcepcionApuesta con un parametro tipo String.
	 ...
	 */
	public ExcepcionApuesta(String mensaje) {
		super(mensaje);
	}
